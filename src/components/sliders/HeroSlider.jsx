  ...
  return (
    <Wrapper>
      ...
      >
        ...
        <SwiperSlide>
          <HeroSliderCard bgimg={"/img/productbg3.png"}  img={"/img/product5png.png"} desc={"A cream designed to soothe and alleviate symptoms associated with skin irritation and inflammation."} title={"Luecan Cream"} subtitle={"Luecan Cream"}/>
        </SwiperSlide>
        <SwiperSlide>
